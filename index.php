                ...
                <div class="col-lg-6 order-lg-1">
                    <div class="p-3">
                        ...
                        <p class="aboutMe__btn">
                            <a id="btnCV" href="https://.github.io/Portafolio/img/cv-mary-katty-vicu%C3%B1a-ore.pdf" download="cvMaryKatty" class="botones btn btn-lg active aos-init" target="_blank" data-aos="fade-up">DESCARGAR CV</a>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-title">
                                <a href="https://.github.io" class="botones btn btn-lg active" target="_blank">
                                DEMO </a>
                                <a href="https://github.com" class="botones btn btn-lg active" target="_blank">
                                CÓDIGO </a>
                            </div>
                        </div>
                    </div>
